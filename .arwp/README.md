...
Audience: Data migration and master-data investigators. Useful action: Trace an object across the synthetic customer chain and inspect source-row provenance.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/data-relationship-map/
...
Compare name-based matching with explicit cross-system identity links using ambiguous and broken reference fixtures.
